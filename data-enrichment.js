...
window.TRIP_ENRICH = {
  ...
  attractions: {
    ...
    // ---- Day 7: Ullapool → Gairloch (drive day) -----------------------------
    ...
    "Big Sand Beach": {
      blogs: [
        { title: "West Highland beaches — our pick", source: "Walkhighlands", url: "https://www.walkhighlands.co.uk/news/our-pick-scotlands-west-highland-beaches/" }
      ]
    },
