...
window.TRIP = {
  ...
  days: [
...

    {
      ...
      hero: "Inverness",
      blurb: "The A9 climbs over the Pass of Drumochter and straight through the Cairngorms National Park — Britain's biggest — before dropping to Inverness and down the west shore of Loch Ness to Drumnadrochit, your base for two nights. Break the drive at Aviemore for ancient Caledonian forest and Cairngorms scenery — the mountain funicular reopens 27 Jul, so you will ride the Nevis Range gondola at Fort William instead.",
      attractions: [
