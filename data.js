...
window.TRIP = {
  ...
  days: [
...

    {
      ...
      hero: "Inverness",
      blurb: "The A9 climbs over the Pass of Drumochter and straight through the Cairngorms National Park — Britain's biggest — before dropping to Inverness and down the west shore of Loch Ness to Drumnadrochit, your base for two nights. Break the drive at Aviemore for ancient Caledonian forest and Cairngorms scenery — the mountain funicular reopens 27 Jul, so you will ride the Nevis Range gondola at Fort William instead. Settle in at Drumnadrochit — a Loch Ness cruise from the pier is the afternoon must-do, with Balmacaan Wood, Blairbeg Park and the Falls of Foyers close by.",
      attractions: [
        ...
        { name: "Cairngorm Mountain Railway", lat: 57.133, lng: -3.671, wiki: "Cairngorm_Mountain_Railway", desc: "The funicular reopens 27 Jul — so it is NOT running when you pass on 23 Jul; ride the Nevis Range gondola at Fort William instead (Day 10). The Cairngorms scenery and Rothiemurchus forest still make the stop worthwhile.", url: "https://www.cairngormmountain.org", locale: "Aviemore", enroute: true },
        { name: "Loch Ness Cruise", lat: 57.3320, lng: -4.4770, wiki: "Loch_Ness", desc: "See the legendary loch from the water — Jacobite Cruises leave from Drumnadrochit pier, minutes from your base. An easy hour afloat past Urquhart Castle; Nessie-spotting optional.", url: "https://www.jacobite.co.uk", locale: "Drumnadrochit", mustDo: true },
        { name: "Falls of Foyers", lat: 57.2545, lng: -4.4895, wiki: "Falls_of_Foyers", desc: "A dramatic ~30m waterfall plunging through a wooded gorge on the quiet south side of Loch Ness — a short (steepish) walk from the Foyers car park, with a loop down to the loch shore.", locale: "Foyers" },
        { name: "Blairbeg Park", lat: 57.3320, lng: -4.4780, wiki: null, desc: "Drumnadrochit's community green — home of the Glenurquhart shinty club and Highland Games, with woodland paths behind. A relaxed stroll right by your base.", locale: "Drumnadrochit" },
        { name: "Balmacaan Wood", lat: 57.3350, lng: -4.4900, wiki: null, desc: "Ancient woodland rising behind Drumnadrochit — once the gardens of Balmacaan House, now free public trails through Scots pine, redwoods and rhododendrons, with Loch Ness views.", url: "https://www.woodlandtrust.org.uk/visiting-woods/woods/balmacaan/", locale: "Drumnadrochit" },
        { name: "River Ness", lat: 57.4700, lng: -4.2320, wiki: "River_Ness", desc: "The short, salmon-rich river linking Loch Ness to the sea at Inverness — the Ness Islands walk (Victorian footbridges to wooded islets) is a lovely gentle stroll in town.", locale: "Inverness" }
      ],
      hotels: [
...

    {
      ...
      attractions: [
        { name: "Eilean Donan Castle", seq: 1, lat: 57.274, lng: -5.5161, wiki: "Eilean_Donan", desc: "The most photographed castle in Scotland, on a tidal island where three sea lochs meet — the perfect mid-morning stop on the drive west.", url: "https://www.eileandonancastle.com", locale: "Dornie", enroute: true },
        { name: "Five Sisters of Kintail", seq: 2, lat: 57.178, lng: -5.34, wiki: "Five_Sisters_of_Kintail", desc: "Scotland's most dramatic mountain drive — the view through the windscreen IS the experience. Slow down on the A87 through Glen Shiel.", locale: "Glen Shiel", enroute: true },
        { name: "Old Man of Storr", seq: 3, lat: 57.507, lng: -6.1836, wiki: "Old_Man_of_Storr", desc: "Skye's iconic rock pinnacle, about 30 min north of Sconser — big views from the roadside pull-offs and the lower path. A perfect first Skye stop on the way over.", locale: "Trotternish" },
        { name: "Kilt Rock & Mealt Falls", seq: 4, lat: 57.6083, lng: -6.1636, wiki: "Kilt_Rock", desc: "A basalt sea-cliff that looks like a pleated kilt, with a waterfall plunging straight into the sea — a five-minute viewpoint a little further up the Trotternish coast.", locale: "Trotternish" },
        { name: "The Quiraing", seq: 5, lat: 57.6437, lng: -6.268, wiki: "Quiraing", desc: "Otherworldly landslip of pinnacles and hidden plateaus — the roadside viewpoint at the Quiraing car park delivers the drama with no climb needed.", locale: "Staffin" },
        { name: "Fairy Glen", seq: 6, lat: 57.586, lng: -6.356, wiki: "Fairy_Glen,_Skye", desc: "A miniature landscape of grassy cones and spiral stone rings near Uig — a gentle 15-minute wander, wonderfully odd.", locale: "Uig" }
      ],
      hotels: [],
      restaurants: []
    },

    {
      ...
      attractions: [
        { name: "Dunvegan Castle & Gardens", seq: 1, lat: 57.449, lng: -6.59, wiki: "Dunvegan_Castle", desc: "Skye's key castle — seat of Clan MacLeod for 800 years, with lovely waterside gardens. A relaxed couple of hours; about 1h15 from Sconser.", url: "https://www.dunvegancastle.com", locale: "Dunvegan", bookAhead: true, bookNote: "Busy in summer — book online to skip the queue." },
        { name: "Dunvegan Castle Seal Trip", seq: 2, lat: 57.4470, lng: -6.5870, wiki: null, desc: "A gentle 25-min open-boat trip from the jetty below Dunvegan Castle to the Loch Dunvegan seal colony (herons and sea eagles too). Walk-up, no booking — boats run on demand 10:00–16:30 (last boat 16:30). £14 adult / £10.50 child; needs a castle or garden ticket.", url: "https://www.dunvegancastle.com/seal-trip/", locale: "Dunvegan" },
        { name: "Claigan Coral Beaches", seq: 3, lat: 57.49, lng: -6.621, wiki: "Claigan", desc: "Beaches of crushed white coralline algae glowing against turquoise water — an easy 30-min shoreline walk about 10 min north of Dunvegan.", locale: "Dunvegan" },
        { name: "Neist Point Lighthouse", seq: 4, lat: 57.4256, lng: -6.7876, wiki: "Neist_Point", desc: "Skye's westernmost tip — clifftop views over the lighthouse out to the Hebrides. Add only if time allows: it's ~45 min further west of Dunvegan.", locale: "Glendale" }
      ],
      hotels: [],
      restaurants: [
...

    {
      ...
      attractions: [
        { name: "Fairy Pools", seq: 2, lat: 57.2493, lng: -6.2599, wiki: "Fairy_Pools", desc: "Crystal-clear turquoise pools and little waterfalls at the foot of the Cuillin — a flat 20–30 min there-and-back — an easy stop after the morning boat.", locale: "Glenbrittle" },
        { name: "Seaprobe Atlantis (glass-bottom boat)", seq: 1, lat: 57.2810, lng: -5.7130, wiki: null, desc: "The day's highlight — Britain's only semi-submersible glass-bottom boat, from Kyle of Lochalsh out under the Skye Bridge. Take a seat in the below-water viewing gallery to watch the kelp forest, seals, Seal Island and a protected bird colony. 1 hr (a 2-hr wreck version runs on some tides). Booked for Mon 27 Jul, 10:15–11:15.", url: "https://www.seaprobeatlantis.com/boat-trips", locale: "Kyle of Lochalsh", booked: true, bookNote: "✓ Booked — Mon 10:15–11:15, 2 adults + 1 youth. Meet at the Pontoon, Station Rd car park, Kyle of Lochalsh IV40 8AE; be there 10 min early." }
      ],
      hotels: [],
      restaurants: [
...

    {
      ...
      hero: "Beinn_Eighe",
      blurb: "An easy morning in Wester Ross before the drive south. The A832 runs the length of beautiful Loch Maree with the great bulk of Slioch across the water; stop at the Beinn Eighe reserve viewpoints for the mountain scenery, then head down to Fort William — your single base for the next THREE nights (one unpack for the Road to the Isles and the Glencoe day-trip). Arrive mid-afternoon and ride the Nevis Range gondola up Aonach Mòr for the big Ben Nevis views.",
      attractions: [
        ...
        { name: "Nevis Range Mountain Gondola", lat: 56.8180, lng: -4.9700, wiki: "Nevis_Range", desc: "Britain's only mountain gondola — a 15-min ride up Aonach Mòr to a 650m top station with a café and huge views across to Ben Nevis. No climbing; open daily through summer. The relaxed swap for the closed-till-27-Jul Cairngorm funicular.", url: "https://www.nevisrange.co.uk/activities/mountain-gondola/", locale: "Fort William", mustDo: true }
      ],
      hotels: [
...

    {
      ...
      title: "Glenfinnan, the canal & Ben Nevis",
      ...
      leg: "Day out from Fort William · Glenfinnan · the Caledonian Canal · Ben Nevis",
      route: "A830 west + Glen Nevis",
      miles: "60", drive: "—",
      overnight: "Fort William (night 2 of 3)",
      hero: "Glenfinnan_Viaduct",
      blurb: "✓ Done — a cracking first Fort William day. West on the A830 'Road to the Isles' for the Glenfinnan Viaduct of Harry Potter fame (with the Jacobite steam train crossing) and the Monument on Loch Shiel, plus a cruise out on the loch. Back near town: Neptune's Staircase — Thomas Telford's eight-lock canal flight — and the classic view of Ben Nevis, Britain's highest mountain, from the Glen Nevis road.",
      attractions: [
        { name: "Glenfinnan Viaduct", seq: 1, lat: 56.8728, lng: -5.4357, wiki: "Glenfinnan_Viaduct", desc: "✓ Done. The 21-arch viaduct of Harry Potter fame — and you caught the Jacobite steam train crossing it.", locale: "Glenfinnan", enroute: true },
        { name: "Glenfinnan Monument", seq: 2, lat: 56.87, lng: -5.433, wiki: "Glenfinnan_Monument", desc: "✓ Done. On Loch Shiel where Bonnie Prince Charlie raised his standard in 1745 — plus a cruise out on the loch.", url: "https://www.nts.org.uk/visit/places/glenfinnan-monument", locale: "Glenfinnan", enroute: true },
        { name: "Neptune's Staircase", seq: 3, lat: 56.843, lng: -5.103, wiki: "Neptune%27s_Staircase", desc: "✓ Done. Telford's eight-lock flight lifting the Caledonian Canal at Banavie, Ben Nevis behind.", locale: "Banavie" },
        { name: "Ben Nevis", seq: 4, lat: 56.7969, lng: -5.0037, wiki: "Ben_Nevis", desc: "✓ Done. Britain's highest mountain (1,345m), admired from the Glen Nevis road at its foot.", locale: "Fort William" }
      ],
      hotels: [],
      restaurants: [
        { name: "Fort William High Street / Crannog", note: "Casual dinner in town, or lochside seafood at Crannog on the old pier.", url: "https://crannog.net/" }
      ]
    },

    {
      ...
      title: "Glencoe",
      stay: { name: "Beinn Brèagha House, Fort William", lat: 56.829, lng: -5.101, mapUrl: "https://www.google.com/maps/search/?api=1&query=13%20Lochy%20Road%20Fort%20William%20PH33%206NJ" },
      leg: "Day out from Fort William · Three Sisters · Glen Etive · Rannoch Moor",
      route: "A82 · ~40 min each way",
      miles: "70", drive: "—",
      overnight: "Fort William (night 3 of 3)",
      hero: "Glen_Coe",
      blurb: "Today's the big one — Scotland's most dramatic glen, ~40 min south on the A82. Start at the Glencoe Visitor Centre for the story of the 1692 massacre, pull in at the Three Sisters viewpoint, then drive the dead-end Glen Etive road (the Skyfall glen) into the mountains. Just beyond the head of the glen the A82 crosses the vast wilderness of Rannoch Moor. Lunch at the legendary Clachaig Inn, and for an easy finish the flat Glencoe Lochan loop by the village is a gentle stroll. No big hikes needed — it's all roadside viewpoints and short walks.",
      attractions: [
        { name: "Glencoe Visitor Centre", seq: 1, lat: 56.674, lng: -5.101, wiki: "Glen_Coe", desc: "First stop coming into the glen — the story of the 1692 massacre, ranger info, a café, and an easy Signal Rock woodland loop behind it.", url: "https://www.nts.org.uk/visit/places/glencoe", locale: "Glencoe", enroute: true },
        { name: "Three Sisters of Glencoe", seq: 2, lat: 56.668, lng: -4.998, wiki: "Glen_Coe", desc: "The iconic viewpoint — three great ridges towering over the A82, with the Meeting of Three Waters nearby. Pull in and take it in; no walking required.", locale: "Glencoe", mustDo: true },
        { name: "Glen Etive", seq: 3, lat: 56.6164, lng: -5.0034, wiki: "Glen_Etive", desc: "A 12-mile dead-end road into a remote, beautiful glen (the Skyfall location) off the head of Glencoe — one of Scotland's great scenic drives. Allow about an hour round trip; watch for red deer.", locale: "Glencoe" },
        { name: "Rannoch Moor", seq: 4, lat: 56.6, lng: -4.75, wiki: "Rannoch_Moor", desc: "One of Europe's last great wildernesses — a vast sweep of bog, lochans and mountains the A82 crosses at the top of the glen. Stop at the laybys. (You'll cross it again on tomorrow's drive south, so skip if short on time.)", locale: "Rannoch Moor" },
        { name: "Glencoe Lochan (optional, easy)", seq: 5, lat: 56.6905, lng: -5.1085, wiki: null, desc: "Optional gentle finish — a flat, well-made loop around a wooded lochan by Glencoe village (planted to remind a homesick Canadian bride of home). About 40 min, pram-friendly.", locale: "Glencoe" }
      ],
      hotels: [],
      restaurants: [
        { name: "Clachaig Inn (Boots Bar)", note: "Legendary Glencoe walkers' pub tucked under the peaks — the classic mid-day lunch stop.", url: "https://www.clachaig.com" }
      ]
    },
